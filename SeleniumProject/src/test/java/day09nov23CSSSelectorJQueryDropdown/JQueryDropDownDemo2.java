...
public class JQueryDropDownDemo2 {

	private static void getSelect(List<WebElement> low, String... str) 
	{
		...
		for(WebElement x : low)
		{
			...
			if(x.getText().equals(val) || str[0].equals("All") )
					x.click();
			}
		}
	...
	*/		
	...
	//	getSelect(low,"choice 2");
		getSelect(low,"choice 6", "choice 7"," choice 6 2 1");
	//	getSelect(low,"All");
	}
